...
test_dataset = "power_grasp3.bag"      # <-- Change here to use a different file
...
#plot_emg(aligned_emg_train, title='sEMG Signals - Not Filtered (Mean Aligned)')
...
#plot_emg(filtered_emg_train, title='sEMG Signals - Filtered')
...
#plot_emg_synergies(final_emg_for_nmf, H, optimal_synergies_nmf)
